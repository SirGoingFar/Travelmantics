...
public class SignInActivity extends AppCompatActivity {
    ...
    public static final String KEY_SIGN_IN_TYPE = "key_signin_type";
    public static final String TYPE_OTHER_MAIL_CLIENT = "type_other_mail_client";
    public static final String TYPE_GOOGLE_MAIL_CLIENT = "type_google_mail_client";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOnboardingSwitcher = findViewById(R.id.tv_sign_up);
